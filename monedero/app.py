...
def archivos_permitidos(filename):
    # rsplit puede recibir dos parametros, el primer parametro es el caracter a dividir y el segundo 
    # opcional es el que especifica en cuantas partes debe ser dividido
